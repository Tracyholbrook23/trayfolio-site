...
export default function WorkPage() {
  return <MarketingShell>
    <PageHero eyebrow="Work" title="Different businesses deserve different digital worlds." intro="Explore real client work and clearly labeled concept projects—each built around a specific business, audience, and next step."><PrimaryCta /></PageHero>
