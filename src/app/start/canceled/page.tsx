      ...
      <main id="main-content" className="flex-1 pb-[var(--stack-overlap)]">
        <section className="mx-auto max-w-2xl px-6 py-24 text-center sm:py-32">
          ...
          <p className="mx-auto mt-6 max-w-md text-lg leading-8 text-stone-600">
            You can return to the demo page whenever you are ready. If something was
            unclear, send a message and Trayfolio will help.
          </p>
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link href="/demo" className="rounded-full bg-terracotta px-6 py-3 text-sm font-semibold text-white transition hover:bg-terracotta-light">
              Back to the demo
            </Link>
